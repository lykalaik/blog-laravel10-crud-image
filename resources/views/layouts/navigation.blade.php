    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex items-center">
                <!-- Rounded Logo -->
                <div class="shrink-0 flex items-center rounded-full">
                    <a href="{{ route('home') }}">
                        <img src="{{ URL ('images/datdat.png') }}" alt="Logo" class="block h-9 w-auto fill-current text-gray-800">
                    </a>
                </div>
            ...
            <div class="flex items-center ml-4">
                ...
                <div class="flex items-center ml-4">
                    <a href="{{ route('profile.edit') }}" class="text-gray-500 hover:text-gray-900">
                        <button class="flex items-center text-sm font-medium text-gray-500 hover:text-gray-900">
                            Profile
                        </button>
                    </a>
                </div>
